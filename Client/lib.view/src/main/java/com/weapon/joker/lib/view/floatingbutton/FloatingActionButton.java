 ...
 * <pre>
 *     author : xiaweizi
 *     class  : com.weapon.joker.lib.view.floatingbutton.FloatingActionButton
...
public class FloatingActionButton extends android.support.v7.widget.AppCompatImageButton {
    ...
    @Retention (RetentionPolicy.SOURCE) @IntDef ({SIZE_NORMAL, SIZE_MINI}) public @interface FAB_SIZE {}
    ...
    void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.ActionButton, 0, 0);
        mColorNormal = attr.getColor(R.styleable.ActionButton_fab_colorNormal, getColor(android.R.color.holo_blue_dark));
        mColorPressed = attr.getColor(R.styleable.ActionButton_fab_colorPressed, getColor(android.R.color.holo_blue_light));
        mColorDisabled = attr.getColor(R.styleable.ActionButton_fab_colorDisabled, getColor(android.R.color.darker_gray));
        mSize = attr.getInt(R.styleable.ActionButton_fab_sizes, SIZE_NORMAL);
        mIcon = attr.getResourceId(R.styleable.ActionButton_fab_icon, 0);
        mTitle = attr.getString(R.styleable.ActionButton_fab_title);
        mStrokeVisible = attr.getBoolean(R.styleable.ActionButton_fab_stroke_visible, true);
        attr.recycle();
    ...
    void updateBackground() {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{getResources().getDrawable(
                mSize == SIZE_NORMAL ? R.drawable.fab_bg_normal :
                        R.drawable.fab_bg_mini), createFillDrawable(strokeWidth), createOuterStrokeDrawable(strokeWidth), getIconDrawable()});
