package com.weapon.joker.lib.view.floatingbutton;
 ...
 * <pre>
 *     author : xiaweizi
 *     class  : com.weapon.joker.lib.view.floatingbutton.FloatingActionsMenu
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.ActionsMenu, 0, 0);
        mAddButtonPlusColor = attr.getColor(R.styleable.ActionsMenu_fab_addButtonPlusIconColor, getColor(android.R.color.white));
        mAddButtonColorNormal = attr.getColor(R.styleable.ActionsMenu_fab_addButtonColorNormal,
                                              getColor(android.R.color.holo_blue_dark));
        mAddButtonColorPressed = attr.getColor(R.styleable.ActionsMenu_fab_addButtonColorPressed,
                                               getColor(android.R.color.holo_blue_light));
        mAddButtonSize = attr.getInt(R.styleable.ActionsMenu_fab_addButtonSize, FloatingActionButton.SIZE_NORMAL);
        mAddButtonStrokeVisible = attr.getBoolean(R.styleable.ActionsMenu_fab_addButtonStrokeVisible, true);
        mExpandDirection = attr.getInt(R.styleable.ActionsMenu_fab_expandDirection, EXPAND_UP);
        mLabelsStyle = attr.getResourceId(R.styleable.ActionsMenu_fab_labelStyle, 0);
        mLabelsPosition = attr.getInt(R.styleable.ActionsMenu_fab_labelsPosition, LABELS_ON_LEFT_SIDE);
        attr.recycle();
        ...
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    if (label != null) {
                        int labelXAwayFromButton = mLabelsPosition == LABELS_ON_LEFT_SIDE ? labelsXNearButton - label.getMeasuredWidth() :
    ...
    private void createLabels() {
        @SuppressLint ("RestrictedApi") Context context = new ContextThemeWrapper(getContext(), mLabelsStyle);
